...
import com.example.akoleih.home.adapter.OnMealClickListener;
...
public class HomeMealsSecondFragment extends Fragment implements HomeView, OnMealClickListener {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        presenter = new HomePresenterImpl(this,new HomeRepositoryImpl(null, new MealRemoteDataSourceImpl()));
    }
